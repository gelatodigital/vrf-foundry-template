...
import "../src/SimpleVRFContract.sol";
...
contract TestSimpleVRFContract is Test {
    ...
    function testFulfillRandomness() public {
        ...
        assertEq(requestTime, 1700819134); // 1700819134 is the block timestamp that was set in the setUp function
        assertEq(requestBlock, 1); // The block number of the request is 1
        assertEq(fulfilledTime, 1700819134); // 1700819134 is the block timestamp that was set in the setUp function
